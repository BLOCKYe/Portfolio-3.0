        ...
        <div className={'grid justify-center w-full'}>
          <div className='max-w-5xl w-full p-5 py-10 flex flex-col min-h-screen'>
            ...
            {!this.state.isSend && (
              <form className='mt-20 animation-fade-3'>
                <div className='grid gap-3'>
                  <div className='text-sm'>What is your full name?</div>
                  <Input
                    variant={'filled'}
                    type={'text'}
                    ...
                    className={
                      'focus:!border-extra-color !bg-justDark-light !border-[1px] !text-sm'
                    }
                  />
                </div>

                <div className='grid gap-3 mt-10'>
                  <div className='text-sm'>What is your email address?</div>
                  <Input
                    variant={'filled'}
                    type={'email'}
                ...
                <div className='mt-10 flex gap-3 md:gap-5 justify-end items-center'>
                  ...
                  <Button
                    ...
                    loadingText={'Sending'}
                    className={
                      '!rounded !bg-justDark-light !py-2 !px-5 !transition-all ' +
            ...
            {this.state.isSend && (
              <div
                className={
                  'mt-20 animation-fade-3 tex grid gap-3 place-items-center text-center'
                }>
